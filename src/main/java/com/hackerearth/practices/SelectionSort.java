 ...
 * <p>
 * The minimum element in the array i.e. 2 is searched for and then swapped with the element that is currently located
 * at the first position, i.e. 7
 * <p>
 ...
 * for(int i = 0; i < n-1 ; i++)  {
 * <p>
 * // assuming the first element to be the minimum of the unsorted array . minimum = i ;
 * <p>
 * // gives the effective size of the unsorted  array .
 * <p>
 * for(int j = i+1; j < n ; j++ ) { if(A[ j ] < A[ minimum ])  {                //finds the minimum element minimum = j
 * ; } } // putting minimum element on its proper position. swap ( A[ minimum ], A[ i ]) ; } }
 * <p>
 * At i'th iteration, elements from position 0 to i - 1
 * <p>
 * will be sorted.
 * <p>
 ...
 * Time Complexity:
 * <p>
 * To find the minimum element from the array of N elements, N - 1 comparisons are required. After putting the minimum
 * element in its proper position, the size of an unsorted array reduces to N - 1 and then N - 2
 * <p>
...
public class SelectionSort {
    ...
    public static void main(String[] args) throws Exception {
        ...
        selectionSort(array, array.size(), numberOfSteps);
    }


    static void selectionSort(List<Integer> array, int sizeOfArray, int numberOfSteps) {
